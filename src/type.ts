...
export type TypeByDouyinHandle = {
    ...
    postByFlower: (userInfo: TypeByUserInfo) => Promise<null | any>,
    postByLike: (videoInfo: AwemeList) => Promise<string>,
    judgeByVideoLikeNum: (videoInfo: AwemeList) => boolean,
    judgeByPublicUserInfo: (videoInfo: AwemeList) => Promise<string>,
